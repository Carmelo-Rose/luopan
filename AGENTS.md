...
- The short-video API accepts L2 `category_id`. L3/leaf ids return empty. The accessories lane therefore collects `服饰内衣 > 服装` once and locally splits products by returned `product_info.leaf_category_id`.
